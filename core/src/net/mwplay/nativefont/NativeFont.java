...
public class NativeFont extends BitmapFont {
    ...
    private NativeFontListener listener;
    ...
    public NativeFont(NativeFontListener listener) {
        this(listener, new NativeFontPaint());
    }

    public NativeFont(NativeFontListener listener, NativeFontPaint paint) {
