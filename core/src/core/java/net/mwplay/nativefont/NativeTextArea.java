...
public class NativeTextArea extends NativeTextField {
    ...
    public NativeTextArea (String text, TextFieldStyle style) {
        super(text, style);
    }
    ...
    public class TextAreaListener extends TextFieldClickListener {
        ...
        public boolean keyDown (InputEvent event, int keycode) {
            ...
            if (stage != null && stage.getKeyboardFocus() == NativeTextArea.this) {
